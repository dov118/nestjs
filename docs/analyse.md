...
### 3.b 🟡 Socket.IO annoncé dans la stack mais absent du code
...
### 3.c 🟡 `DB_NAME` : défaut incohérent dans la branche MySQL
...
### 3.d Pas de DTO + validation — STANDBY (pas encore de controller)
...
### 3.f 🟡 Git Flow documenté ≠ workflows réels
